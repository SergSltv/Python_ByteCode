...
class Frame:
    ...
    def load_name_op(self, arg: str) -> None:
        ...
        # elif arg in self.builtins.__dict__:
        #     self.push(self.builtins.__dict__[arg])
        else:
    ...
    def make_function_op(self) -> None:
        ...
        def bind_args(code, *args: tp.Any, **kwargs: tp.Any) -> dict[str, tp.Any]:
            ...
            # TODO вернуть аргументы для defaults и kwdefaults
            defaults =  ()
        ...
        # defaults and kwdefaults, depending on flags
        defaults = ()
        kwdefaults = {}

        # if flags & 0x01:  # has defaults tuple
        #     defaults = self.pop()
        # if flags & 0x02:  # has kwdefaults dict
        #     kwdefaults = self.pop()
    ...
    # TODO не нашёл следующие три в dis
    ...
    def copy_op(self, arg: int) -> None:
        ...
        self.push(self.data_stack[-1 - arg])
    ...
    def load_fast_op(self, arg: tp.Any) -> None:
        if arg in self.locals:
            ...
            self.push(self.builtins[arg])
        # self.push(self.code.co_varnames[arg])
        # self.push(self.locals[arg])
    ...
    def store_fast_store_fast_op(self, arg: int) -> None:
        ...
        # self.locals[varnames[var1_index]] = v1
        # self.locals[varnames[var2_index]] = v2

    def store_fast_load_fast_op(self, arg: tuple[str]) -> None:

        # Сохраняем верхний элемент стека в locals[var1]
        value = self.pop()
        self.locals[arg[0]] = value

        # Загружаем locals[var2] обратно на стек
